...
this["JST"]["board_menu_item"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<a href='/b/"
    ...
    + "'><span class=\"tab\"></span><h1>"
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + "</h1><div class=\"icon-sm icon-star "
...
this["JST"]["board_menu"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<input type=\"text\" placeholder=\"Find boards by name...\" id=\"search\"><ul id=\"board_types\"><li><ul id=\"search_list\"></ul></li><li class=\"board_type\"><span class=\"icon-sm icon-star\"></span><h1>Starred Boards</h1><span class=\"icon-sm icon-add\" id=\"toggle_starred\"></span><ul id=\"starred_list\" class=\"board_type\"></ul></li><li class=\"board_type\"><span class=\"icon-sm icon-clock\"></span><h1>Recent Boards</h1><span class=\"icon-sm icon-add\" id=\"toggle_recent\"></span><ul id=\"recent_list\" class=\"board_type\"></ul></li><li class=\"board_type\"><span class=\"icon-sm icon-board\"></span><h1>Personal Boards</h1><span class=\"icon-sm icon-add\" id=\"toggle_personal\"></span><ul id=\"personal_list\" class=\"board_type\"></ul></li></ul><ul id=\"menu_actions\"><li class=\"menu_action\"><div><a href=\"#\" id=\"create_new_board\">Create new board...</a></div></li><li class=\"menu_action\"><div><a href=\"#\" id=\"always_keep_open\">Always keep this menu open.</a></div></li><li class=\"menu_action\"><div><a href=\"#\" id=\"see_closed_boards\">See closed boards.</a></div></li></ul>";
},"useData":true});
...
this["JST"]["card_overview"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
    ...
    return "<li><span class=\"icon-sm icon-description\"></small></li>";
},"5":function(container,depth0,helpers,partials,data) {
    return "<li>"
    + container.escapeExpression((helpers.length || (depth0 && depth0.length) || helpers.helperMissing).call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.Comments : depth0),{"name":"length","hash":{},"data":data}))
    + "<span class=\"icon-sm icon-comment\"></span></li>";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;
...
this["JST"]["card"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"card_detail\"><div class=\"close\"></div><div class=\"two_columns\"><div class=\"content\"><section id=\"general\"><header><h1><span class=\"icon-lg icon-card\"></span><div contenteditable=\"true\" class=\"edit_title\">"
    ...
    + "</div></section><section id=\"comment\"><header><h1><span class=\"icon-lg icon-comment\"></span>Add Comment</h1></header><div class=\"user_pic\"></div><form id=\"comment_form\" action=\"\"><fieldset><div class=\"comment_container\"><textarea name=\"comment_text\" id=\"comment_text\" cols=\"65\" rows=\"2\" placeholder=\"Write a comment...\"></textarea><div class=\"comment_toolbar\"><div class=\"tools\"><span class=\"icon-sm icon-attachment\"></span><span class=\"icon-sm icon-mention\"></span><span class=\"icon-sm icon-emoji\"></span><span class=\"icon-sm icon-card\"></span></div></div></div><input type=\"submit\" id=\"send_comment\" class=\"btn btn-secondary\" value=\"Send\"></fieldset></form></section><section id=\"activity\"><header class=\"clearfix\"><h1><span class=\"icon-lg icon-activity\"></span>Activity</h1><a href=\"#\">Hide Details</a></header><ul id=\"activity_feed\"></ul></section></div><div class=\"sidebar\"><div class=\"add\"><header><h1>Add</h1></header><ul class=\"edit_add\"><li><button class=\"btn btn-sm btn-block\" id=\"members\"><span class=\"icon-sm icon-member\"></span>Members</button></li><li><button class=\"btn btn-sm btn-block\" id=\"labels\"><span class=\"icon-sm icon-label\"></span>Labels</button></li><li><button class=\"btn btn-sm btn-block\" id=\"checklist\"><span class=\"icon-sm icon-checklist\"></span>Checklist</button></li><li class=\"corner\"><button class=\"btn btn-sm btn-block\" id=\"dueDate\"><span class=\"icon-sm icon-clock\"></span>Due Date</button></li><li><button class=\"btn btn-sm btn-block\" id=\"attachment\"><span class=\"icon-sm icon-attachment\"></span>Attachment</button></li></ul></div><div class=\"edit_actions\"><header><h1>Actions</h1></header><ul class=\"actions_list\"><li><button class=\"btn btn-sm btn-block\" id=\"move\"><span class=\"icon-sm icon-move\"></span>Move</button></li><li><button class=\"btn btn-sm btn-block\" id=\"copy\"><span class=\"icon-sm icon-card\"></span>Copy</button></li><li><button class=\"btn btn-sm btn-block\" id=\"subscribe\"><span class=\"icon-sm icon-subscribe\"></span>Subscribe</button></li><li><button class=\"btn btn-sm btn-block\" id=\"archive-card\"><span class=\"icon-sm icon-archive\"></span>Archive</button></li></ul></div><footer><a href=\"#\" class=\"share\">Share and more...</a></footer></div></div></div>";
},"useData":true});
...
this["JST"]["comment"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"small_user_pic\" id='comment_"
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "'></div><h1><strong>David Kurutz</strong></h1><div class=\"comment\">"
    + alias4(((helper = (helper = helpers.comment_text || (depth0 != null ? depth0.comment_text : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"comment_text","hash":{},"data":data}) : helper)))
    + "</div><div class=\"comment_options\"><small><a href=\"#\" class=\"edit_comment\">Edit</a><a href=\"#\" class=\"delete_comment\">Delete</a></small></div>";
},"useData":true});
...
this["JST"]["list"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<header><div contenteditable=\"true\" class=\"edit_title\">"
    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
    + "</div><span class=\"icon-sm icon-overflow-menu-horizontal list_actions\"></span></header><ul class=\"cards\" id='cards-"
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "'></ul><footer><a href=\"#\">Add a card...</a></footer>";
},"useData":true});
...
this["JST"]["move_list"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<header><span class=\"icon-sm icon-back\"></span><h1>Move List</h1><div class=\"close small\"></div></header><form action=\"#\"><div id=\"select_board\"><h2>Board</h2><strong>"
    + alias4(((helper = (helper = helpers.board_name || (depth0 != null ? depth0.board_name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"board_name","hash":{},"data":data}) : helper)))
    + "</strong><select class=\"hidden_select\" name=\"destination_board\" id=\"destination_board\"><optgroup label=\"Boards\">"
    ...
    + "</optgroup></select></div><div id=\"select_list_position\"><h2>Position</h2><strong>"
    ...
    + "</strong><select class=\"hidden_select\" name=\"destination_position\" id=\"destination_position\"></select></div><input type=\"submit\" value=\"Move\"></form>";
},"useData":true});
